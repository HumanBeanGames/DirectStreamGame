...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .stage {{ --stage-left-column: 0px; --stage-right-column: 0px; --direct-stream-aspect-ratio: {STREAM_WIDTH} / {STREAM_HEIGHT}; --direct-stream-player-size: 240px; width: min(100%, var(--direct-stream-max-player-width)); display: grid; grid-template-columns: min(100%, var(--direct-stream-max-player-width)); grid-template-areas: "player"; gap: 8px; align-items: start; justify-content: center; min-height: 0; }}
